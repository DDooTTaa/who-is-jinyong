...
신비로운 디자인의 개인 포트폴리오 웹사이트입니다. Next.js와 Framer Motion을 활용하여 인터랙티브하고 아름다운 사용자 경험을 제공합니다.

## ✨ 특징

- 🌟 **신비로운 디자인**: 보라색과 파란색 그라데이션을 활용한 미스터리한 분위기
...
### 색상 팔레트
- **Mystic Blue**: `#0ea5e9` - 신비로운 파란색
- **Cosmic Purple**: `#a855f7` - 우주적인 보라색
