...
const companyGroups: {
...
}[] = [
  {
    ...
    projects: [
      ...
      {
        title: 'B2B 프랜차이즈 매장 메뉴 일괄 배포',
        summary: '테이블 오더 메뉴잇 - 프랜차이즈 본사에서 가맹점 메뉴를 한 번에 배포할 수 있는 기능을 기획부터 디자인·개발까지 구현.',
        technologies: ['React', 'TypeScript'],
        category: 'B2B Service',
        role: '기획 / 디자인 / 프론트엔드 개발',
        challenges: '가맹점마다 메뉴를 따로 수정하면 본사 운영 부담이 크고, 매장별 메뉴 상태를 깨지 않으면서 여러 매장에 한 번에 반영하는 배포 흐름이 필요했습니다.',
        solutions: '본사 기준 메뉴를 가맹점에 일괄 배포하는 화면과 배포 플로우를 기획·디자인하고 프론트엔드로 구현',
        learnings: 'B2B 프랜차이즈는 단일 매장 UX와 달리 본사–가맹점 배포 단위를 먼저 맞춰야 운영 실수를 줄일 수 있습니다.',
      },
      {
