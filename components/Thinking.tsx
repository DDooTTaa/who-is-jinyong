...
const questions = [
  {
    ...
    verdict: '완성도가 아니라, 전제가 살아 있는지로 버립니다.',
    body: [
      {
        heading: '직원 관리 서비스 — 미국 팁 정산',
        paragraphs: [
          '메뉴잇에서 미국 매장의 팁 문화에 맞춘 근무 시간·팁 정산 서비스를 기획부터 디자인·개발까지 진행했습니다. 정산 단위와 화면 흐름까지 잡아 둔 상태였습니다. 경영 환경이 바뀌면서 미국 확장 전제가 사라졌고, 그 지점에서 접었습니다.',
          '버리기로 판단한 근거는 세 가지였습니다. 이 기능이 푸는 문제는 한국 매장의 당면 과제가 아니라 미국 팁 정산이라는 점, 전제가 사라지면 잘 만든 기능도 유지보수 부채가 된다는 점, 제가 이미 쓴 시간보다 팀이 앞으로 쓸 시간의 기회비용이 더 크다는 점입니다. 미련은 코드가 아니라 기획에서 얻은 통찰에만 남겼습니다. 문화가 다른 시장은 UX를 번역하는 게 아니라, 정산 단위 자체를 다시 정의해야 합니다.',
        ],
      },
      {
        heading: '내가 짠 3만 줄',
        paragraphs: [
          '화이트 라벨링과 컴포넌트 공통화 과정에서, 제가 포함해 쌓아 온 중복 UI를 3만 줄 이상 걷어냈습니다. 기준은 “이 코드가 아직 쓸모 있는가”가 아니라 “이 코드가 다음 수정의 속도를 늦추는가”였습니다. 브랜드마다 조금씩 다른 버튼이 생기면 버그도 브랜드 수만큼 복제됩니다. 만든 사람의 자부심보다, 이후 작업의 속도를 골랐습니다.',
        ],
      },
    ],
  },
      ...
      <article className="gh-card overflow-hidden">
        ...
        <div className="px-4 py-6 sm:px-8">
          ...
          <nav aria-label="문항 목차" className="mb-8 rounded-gh border border-border bg-canvas-subtle p-4">
            <p className="mb-2 text-xs font-semibold text-fg-muted">목차</p>
